...
import { stateService, getStateService, createStateService, updateStateService, deleteStateService, getstatewithcityService } from "./state.service";
...
export const getStatewithcity = async (c: Context) => {
    try{
